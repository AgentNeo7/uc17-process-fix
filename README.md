# UC17 — Failure-to-Process-Fix Kit

Groups linked events by declared component, category and signature, ranks unique case counts, preserves unlinked events, attaches evidence to repair hypotheses and compares before/after rates with explicit confounders.
...
No causal fault localization, native telemetry adapters, clock reconciliation, automatic fixes, externally submitted tickets or matched-cohort recurrence attribution.
...
- [Celonis process improvement](https://www.celonis.com/platform/process-improvement) — Celonis describes coordinating agents, people and existing systems. This establishes product overlap, not independently verified performance.
